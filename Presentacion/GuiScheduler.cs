...
namespace Simulador_Scheduler
{
    public partial class GuiScheduler : Form
    {
        ...
        private void btnAddProcess_Click(object sender, EventArgs e)
        {
            ...
            {
                Nombre = name,
                Prioridad = int.Parse(txtPriority.Text.Trim())
            });
        ...
        private void populateItems()
        {
            ...
            {
                listProcessors[i] = new ListProcessor(processorList[i].Procesos, processorList[i]);
        ...
        private void GuiScheduler_Load(object sender, EventArgs e)
        {
        ...
        private void txtProcessors_TextChanged(object sender, EventArgs e)
        {
